...
-- update this data-backup.sql file if you want to restore the database.
...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2025 at 10:01 AM
...
INSERT INTO `downpayment_tracker` (`id`, `lead_id`, `reservation_date`, `requirements_complete`, `dp_terms`, `current_dp_stage`, `total_dp_stages`, `pagibig_bank_approval`, `loan_takeout`, `turnover`, `progress_rate`, `created_at`, `updated_at`) VALUES
(1, 7, '2025-05-22', 1, '15', 15, 15, 1, 1, 1, 100.00, '2025-05-21 08:12:15', '2025-05-21 09:34:53'),
(2, 6, NULL, 1, '24', 7, 24, 1, 1, 0, 60.00, '2025-05-21 08:28:07', '2025-05-23 01:29:48'),
(3, 8, '2025-05-21', 1, '12', 12, 12, 1, 1, 1, 100.00, '2025-05-21 09:41:30', '2025-05-21 13:10:51');
...
(6, 24, 'Leonard Pistano', '0919993939393', 'leoanrd10238983@gmail.com', '', '', 'Warm', 'Downpayment Stage', 'Facebook Groups', 'Antipolo Heights', 'Lot Only', 10000000.00, 'none', '2025-05-19 02:53:41', '2025-05-22 15:14:07'),
(7, 15, 'Jerome Badua ', '09292992929', 'jerome@gmail.com', 'fb.com', 'linkedin.com', 'Cold', 'Downpayment Stage', 'Landing Page', 'Pleasantfields', 'Kennedy', 0.00, '0.00', '2025-05-21 05:03:02', '2025-05-23 05:59:38'),
...
(9, 30, 'Marvey Yenzo', '09191919', 'yenz@gmail.com', '', '', 'Hot', 'Inquiry', 'Facebook Groups', 'Pleasantfields', 'Kennedy', 2000000.00, 'yes yes yes ', '2025-05-22 15:12:55', '2025-05-23 06:00:03');
...
INSERT INTO `memos` (`memo_id`, `title`, `content`, `created_by`, `created_at`) VALUES
(1, 'KWekwek ng inamo', 'aksjdasldjaskldjakdjalksd', 15, '2025-05-23 02:55:35'),
(3, 'Exclusice News', 'Pilay nakita ng bulag naglalakad, pagktapos ay narinig nang bingi ang pipe ay sumisigaw. ?????????', 15, '2025-05-23 03:00:13'),
(12, 'Manager', 'This is for manager only! all users should not see this content!', 15, '2025-05-23 05:35:33'),
(15, 'supervisors', 'this content is for SUPERVISORS only, other users should not see this content!', 15, '2025-05-23 05:38:20'),
(16, 'AGENT!', 'this content is for AGENT only, other users should not see this content! hehehe', 15, '2025-05-23 05:40:16'),
(18, 'FOR ALL', 'this content is for all users!', 15, '2025-05-23 05:41:25'),
(19, 'aksjdskjd', 'sjdskdjk', 15, '2025-05-23 06:26:37');
...
--
-- Dumping data for table `memo_images`
--

INSERT INTO `memo_images` (`image_id`, `memo_id`, `image_path`, `image_name`, `upload_date`) VALUES
(2, 3, 'uploads/memo_images/memo_682fe4bdef544.jpg', 'images.jpg', '2025-05-23 03:00:13'),
(10, 12, 'uploads/memo_images/memo_683009259ac2d.jpg', 'ab6761610000e5eb50069ac992d74c5610ecb9cc.jpg', '2025-05-23 05:35:33'),
(13, 15, 'uploads/memo_images/memo_683009cc60f29.jpg', 'istockphoto-538665020-612x612.jpg', '2025-05-23 05:38:20'),
(14, 16, 'uploads/memo_images/memo_68300a406ff6e.jpg', 'images (1).jpg', '2025-05-23 05:40:16'),
(16, 18, 'uploads/memo_images/memo_68300a85e10b8.jpg', 'images (2).jpg', '2025-05-23 05:41:25');
...
--
-- Dumping data for table `memo_visibility`
--

INSERT INTO `memo_visibility` (`visibility_id`, `memo_id`, `visible_to_role`) VALUES
(1, 1, 'manager'),
(2, 1, 'supervisor'),
(3, 1, 'agent'),
(5, 3, 'manager'),
...
(13, 'On-job-training', '2025-06-04 02:25:43');
...
INSERT INTO `users` (`id`, `team_id`, `username`, `password`, `name`, `email`, `role`, `profile_picture`, `created_at`) VALUES
(1, NULL, 'admin', '$2y$10$3iuZEf0f2.uXqGinef6fnOWVGjCYMaP27pTPELt3kPwaUm2xEqeGS', 'Administrator', 'innersparcservices@gmail.com', 'admin', NULL, '2025-05-16 02:45:20'),
(3, 8, 'shielamae.innersparc', '$2y$10$gbLWkM8Lc//nUt5oexmLXOkZSG6PVoIaSMntaSqlgqCB1mlLFRVeG', 'Sheila Mae Fontelo Fajutagana', 'francisheila05@gmail.com', 'agent', NULL, '2025-05-16 02:45:21'),
(4, 2, 'luzvimindalim.innersparc', '$2y$10$PUV7H0RlWs.dJZ6x8SqmvOFy3x9MlJIo0m7otynHJfAxHnktLhC4u', 'Luzviminda Labrado Lim', 'luz032069@gmail.com', 'supervisor', NULL, '2025-05-16 02:45:21'),
(5, 3, 'manager3', '$2y$10$rRuVdtrMXPrd1x.ySHEY3.9Vvjxds.9Js5rCvRPgQG7ug3NzLmMZO', 'Team 3 Manager', 'manager3@example.com', '', NULL, '2025-05-16 02:45:21'),
(6, 1, 'mikegabrielbedionescarilla.innersparc', '$2y$10$wQ4nzPYxWM.8smNno/0vIOfwSvYWxq3yphH3y8QCXxK68d3i8uSPG', 'Mike Gabriel Bedion Escarilla', 'escarilla.mikegabriel@gmail.com', 'agent', NULL, '2025-05-16 02:45:21'),
(7, NULL, 'romeojrcernacorberta.itdept', '$2y$10$rRuVdtrMXPrd1x.ySHEY3.9Vvjxds.9Js5rCvRPgQG7ug3NzLmMZO', 'Romeo Jr. Cerna Cobreta', 'romxcob.innersparc@gmail.com', 'admin', NULL, '2025-05-16 02:45:21'),
(8, 8, 'charlenedellosa.innersparc', '$2y$10$7BvBgpFnDmhhX3/zSVikjebJCWefKLpsg36RYdkM0KhZDmjE/Zmmu', 'Charlene Dellosa', 'dellosacharlene1317@gmail.com', 'manager', 'uploads/profile_pictures/user_8_1747501769.png', '2019-05-16 02:45:23'),
(9, 2, 'alvinllaneta.innersparc', '$2y$10$.w9.aPUWHSS5GifQHPn9Fu2.JKn817TupAc0xAEDSekCnwFDH1UiW', 'Alvin  Llaneta', 'alvinllaneta8@gmail.com', 'agent', NULL, '2025-05-16 02:45:23'),
(10, 3, 'supervisor3', '$2y$10$rRuVdtrMXPrd1x.ySHEY3.9Vvjxds.9Js5rCvRPgQG7ug3NzLmMZO', 'Team 3 Supervisor', 'supervisor3@example.com', '', NULL, '2025-05-16 02:45:23'),
(11, 2, 'clarencedanielleserdon.innersparc', '$2y$10$tRBIk1jyaXGFbpAveJE8gOqFpGW.O/hJInU3qJ/mnqr3k/RBneuQK', 'Clarence Danielle Lim Serdon', 'clarencedanielle98@gmail.com', 'agent', NULL, '2025-05-16 02:45:23'),
(12, 2, 'gabcyrosebenson.innersparc', '$2y$10$GnAbo83uu0hltK474fV1B.It7N5iLugZXtDFd.5vDRuFqso62qcXS', 'Gabcyrose Samsona Benson', 'gabcyrose@gmail.com', 'agent', NULL, '2025-05-16 02:45:23'),
(13, 1, 'lenizaflorespasion.innersparc', '$2y$10$oHDt9M8XyxG7WGe5TusQluJBQXhGLuIz67T5vXM7YYkcPO1y2cXIq', 'Leniza Flores pasion', 'lenizapasion51@gmail.com', 'agent', NULL, '2025-05-16 02:45:23'),
(14, 1, 'perlitasantiagogo.innersparc', '$2y$10$p4kmD3n.wjSirRlDZpwRaOz69x2uytmxIQcBsgRTPpJynvZ5o1I76', 'Perlita Santiago Go', 'gopearl43@yahoo.com', 'agent', NULL, '2025-05-16 02:45:23'),
(15, NULL, 'markpatigayon.itdept', '$2y$10$Tbq4hLp0VyDFdxogyElwm.A52Fh.OLnPqgayZTWrAlY4s.V7XCPdi', 'Mark Christian Patigayon', 'markpatigayon440@gmail.com', 'admin', 'uploads/profile_pictures/user_15_1747499626.jpg', '2019-05-22 02:45:23'),
(16, 1, 'verlynbizcondevesagas.innersparc', '$2y$10$PEX7IJamKPjc2Mg5859AZuLQjqB/anHrK9ty37.dejDgGTEVazAwy', 'Verlyn Bizconde Vesagas', 'vverlyn@gmail.com', 'agent', NULL, '2025-05-19 02:08:49'),
(17, 1, 'rizelagrimas.innersparc', '$2y$10$ipV2yK499HzPJRz4Bw8G0OMKotbJFfC37LzMtCn1qPimCph6f9Dmy', 'Rize OwogOwog Lagrimas', 'rizielagrimas18@gmai.com', 'agent', NULL, '2025-05-19 02:09:39'),
(18, 1, 'ireneblanca.innersparc', '$2y$10$aEQppVOJLQ3050pCQEKrwepJCT8rw3frtf.AqkgMPqw7TjisrYmli', 'Irene Noble Blanca', 'ireneblanca1909@gmail.com', 'agent', NULL, '2025-05-19 02:10:13'),
(19, 1, 'gabriellibacao.innersparc', '$2y$10$0A.MhdXz2UAcy4bUGR6EBOsQ82F9GtlZLgCw0a0n46KXTUuoM8t8a', 'Gabriel Jr. Villamor Libacao', 'libacaoga@gmail.com', 'admin', NULL, '2025-05-19 02:10:58'),
(20, 1, 'erwinbauioan.innersparc', '$2y$10$/I4c/Yn7lWXRlraQvK0m2ueNwa2vgAfJ1NSKVG9wNfXJUu51fjoeq', 'Erwin Gonzales Baguioan', 'irwindgonzales6@gmail.com', 'manager', NULL, '2025-05-19 02:11:50'),
(21, 1, 'nelynortega.innersparc', '$2y$10$pPrIuezkcJ9THUg5IHmFMuo68tv5W5MhSeLarPb4HIFc2rt5Jj8u.', 'Nelyn Serad Ortega', 'orteganelyn18@gmail.com', 'supervisor', NULL, '2025-05-19 02:12:41'),
(22, 1, 'sarahlopez.innersparc', '$2y$10$HFq2/p7EOrkbn0gFTWoCJOC.0jkJX3rAZj0Rg65xuEfvqa7K3cw7K', 'Sarah Jean Lagatic Lopez', 'sarahjeanlopez07@gmail.com', 'supervisor', NULL, '2025-05-19 02:13:10'),
(23, 2, 'nephelepanganiban', '$2y$10$uZrVk47hzppnbZsFYK/SWOAhQ5e04n/rqm8ti4Hkp7FgvWjq9WrW6', 'Nephele Telmo Panganiban', 'nephelepanganiban@gmail.com', 'agent', NULL, '2025-05-19 02:18:33'),
(24, 2, 'joanbarceta.innersparc', '$2y$10$E.XU5PTwBNn6BryqVpHLTOGGmPOz9V1slWHXBZjzg4YeKC00K9o6K', 'Joan Mahinay Barceta', 'jobarceta22@gmail.com', 'manager', 'uploads/profile_pictures/user_24_1747622923.jpg', '2025-05-19 02:19:01'),
(25, 2, 'teresasandoval.innersparc', '$2y$10$WYxXqgw6uC.9r4ukTgt.SOApN.eDGquy0nbDiJpAkfUHGrMQd2bx2', 'Teresa Rosanto Sandoval', 'trscyl@yahoo.com', 'supervisor', NULL, '2025-05-19 02:20:20'),
(26, 2, 'ailynmdetorres.innersparc', '$2y$10$wNLuyURAbK/f1g53h1zuRu.XCIA5u/iFJqU529aWrzYijfu80iIwC', 'Ailyn Llaneta De Torres', 'ailyndetorres8@gmail.com', 'agent', NULL, '2025-05-19 02:21:11'),
(27, 2, 'emilyncantuba.innersparc', '$2y$10$AL8RtPNTg4fhzeCoe8paGuFoFKQspNTe4WuvQmieLbw0BW06OyW/W', 'Emilyn Marcelo Cantuba', 'cantubaemhie@gmail.com', 'agent', NULL, '2025-05-19 02:21:46'),
(28, 2, 'novelitatabudlong.innersparc', '$2y$10$VzOywJiBE7vbcCCgyXyqOO8r5qMiKWJfqXZmINuqXCvyziXMjM3wi', 'Novelita  Letran Tabudlong', 'novzpretty@gmail.com', 'agent', NULL, '2025-05-19 02:22:15'),
(29, 8, 'leodellosa.innersparc', '$2y$10$Cv6hsi.jSxoikgaDi275KO6HQstKWsWIOLA.vIQUfBVCW8BJIX8.i', 'Leo Dellosa', 'leodellosa@example.com', 'agent', NULL, '2025-05-19 02:22:59'),
(30, 8, 'arleneumali.innersparc', '$2y$10$bnwqqAGYP9wCmWeFh6ykNO8Nn78VQ5w.7Owzuxy9ES7HTxAubjRQi', 'Arlene Umali', 'arleneumali@example.com', 'agent', NULL, '2025-05-19 02:24:33'),
(31, 12, 'mannyviolenta.innersparc', '$2y$10$q4AysMNRb0HqK6DV.BSHV.rTaEl86RZI2d1SG/24Sgnkg/G7QUfBi', 'Manny Alberto Violenta', 'violentamanny@gmail.com', 'manager', NULL, '2025-05-19 02:28:42'),
(32, 12, 'annalynviolenta.innersparc', '$2y$10$V/Znwb0nP.g1kKNUqZdMyOhPNKu2Z7A2FEmCReSfVeUy5ogANgND2', 'Annalyn Salting Violenta', 'anniemazing2@gmail.com', 'agent', NULL, '2025-05-19 02:30:01'),
(33, 12, 'anelatabuyan.innersparc', '$2y$10$6ZN3s6dR/KaXtstCjmUpuO.4zc4pcfp9sXCCyelzuENqygUA4FxDa', 'Anela Dela Cruz Tabuyan', 'nela.tab5@gmail.com', 'agent', NULL, '2025-05-19 02:30:31'),
(34, 12, 'jocelynsantos.innersparc', '$2y$10$NiykEjnqVjwx5muaon0Jj.EeIC9shVUcnTvUJk.gk.OB3iEQEAdSO', 'Jocelyn Santos', 'jhoymsantos15@gmail.com', 'agent', NULL, '2025-05-19 02:30:57'),
(35, 12, 'lenilyntimajo.innersparc', '$2y$10$bEn5TV2cX/RhHX28meGlK.OY.XDhKJ2FKhQDCPyW8Urc9V4G2ciZm', 'Lenily  Rana Timajo', 'timajolenily@gmail.com', 'supervisor', NULL, '2025-05-19 02:31:24'),
(36, 12, 'jerusalinosantos', '$2y$10$hYIses3VZ0VyVq9iFYUYeOrjIwkvzoeZlN9spuoOv6bgXHRZzDGwW', 'Jerusalino Tan Santos', 'jerometsantos28@gmail.com', 'supervisor', NULL, '2025-05-19 02:32:16'),
(37, 12, 'novelynbualat.innersparc', '$2y$10$9QLMoE7w01X5z81AVAx6Bu2DX/AmlL8oJM8d4IhN75ZB4LwTWXn0K', 'Novelyn Macalam  Bualat', 'novelynbualat01@gmail.com', 'agent', NULL, '2025-05-19 02:33:04'),
(38, 12, 'edenrosedemerin.innersparc', '$2y$10$H75lWP/UOgcRwFOWNafMqONdmHhER8ZmXIenG3PTgPrXJocXQYYya', 'Eden Rose Ramos Demerin', 'apostolerogalapino@gmail.com0', 'supervisor', NULL, '2025-05-19 02:33:27');
...
--
ALTER TABLE `memos`
  MODIFY `memo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `memo_visibility`
  MODIFY `visibility_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
